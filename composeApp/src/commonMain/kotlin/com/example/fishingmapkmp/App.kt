...
import fishingmapkmp.composeapp.generated.resources.Res
import fishingmapkmp.composeapp.generated.resources.NotoSansTC

@Composable
fun App(viewModel: SharedViewModel) {
    // 🎯 1. 載入 Common Resources 中的中文字型檔
    val customFontFamily = FontFamily(
        Font(Res.font.NotoSansTC, weight = FontWeight.Normal)
    )

    // 🎯 2. 將全域字型覆蓋至 MaterialTheme Typography
    ...
    // 🎯 3. 用自訂的 MaterialTheme 包裹原本所有的 UI
